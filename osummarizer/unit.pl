...
% **********************************************************************
% Pretty printing
% ut(Desc, (   format_to_codes("~p", [In], Codes),
%              format_to_codes(Exp, [], Codes)    )) :- pp_ut(Desc, In, Exp).
...
pp_ut("PP typed const true", true@loc('max.ml', 0, 0, 0, 0, 0, 0):bool, "true:bool").
...
pp_ut("PP named const true", true@loc('max.ml', 0, 0, 0, 0, 0, 0):r:bool, "true:r:bool").
...
ut("path   const ()", n_e_to_p_e1(unit, loc('c.ml', 0, 0, 0, 0, 0, 0), v:unit, true, unit@loc('c.ml', 0, 0, 0, 0, 0, 0):v:unit-->'V'=1)).
...
ut("path   const true", n_e_to_p_e1(true, loc('c.ml', 0, 0, 0, 0, 0, 0), v:bool, true, true@loc('c.ml', 0, 0, 0, 0, 0, 0):v:bool-->'V'=true)).
ut("summ   const true", p_e_to_c1(true, loc('c.ml', 0, 0, 0, 0, 0, 0), v:bool, 'V'=true, {})).

ut("naming const 10", t_e_to_n_e1(10, loc('c.ml', 0, 0, 0, 0, 0, 0), int, v, empty, 10@loc('c.ml', 0, 0, 0, 0, 0, 0):v:int)).
ut("path   const 10", n_e_to_p_e1(10, loc('c.ml', 0, 0, 0, 0, 0, 0), v:int, true, 10@loc('c.ml', 0, 0, 0, 0, 0, 0):v:int-->'V'=10)).
...
ut("path   const \"hola\"", n_e_to_p_e1("hola", loc('c.ml', 0, 0, 0, 0, 0, 0), v:int, true, "hola"@loc('c.ml', 0, 0, 0, 0, 0, 0):str:string-->'V'="hola")).
ut("summ   const \"hola\"", p_e_to_c1("hola", loc('c.ml', 0, 0, 0, 0, 0, 0), v:int, 'V'="hola", {})).

ut("naming const +", t_e_to_n_e1('+', loc('c.ml', 0, 0, 0, 0, 0, 0), (int -> int -> int), v, empty,
                                 '+'@loc('c.ml', 0, 0, 0, 0, 0, 0):'plus_v':('a_plus_v':int -> 'b_plus_v':('ba_plus_v':int -> 'bb_plus_v':int)))).
ut("path   const +", n_e_to_p_e1('+', loc('c.ml', 0, 0, 0, 0, 0, 0), 'plus_v':('a_plus_v':int -> 'b_plus_v':('ba_plus_v':int -> 'bb_plus_v':int)), true,
                                 '+'@loc('c.ml', 0, 0, 0, 0, 0, 0):'plus_v':('a_plus_v':int -> 'b_plus_v':('ba_plus_v':int -> 'bb_plus_v':int))-->'BB_P_V'='A_P_V'+'BA_P_V')).
ut("summ   const +", p_e_to_c1('+', loc('c.ml', 0, 0, 0, 0, 0, 0), 'plus_v':('a_plus_v':int -> 'b_plus_v':('ba_plus_v':int -> 'bb_plus_v':int)), 'BB_P_V'='A_P_V'+'BA_P_V', {})).

ut("naming const >", t_e_to_n_e1('>', loc('c.ml', 0, 0, 0, 0, 0, 0), (int -> int -> bool), v, empty,
                                 '>'@loc('c.ml', 0, 0, 0, 0, 0, 0):'gt_v':('a_gt_v':int -> 'b_gt_v':('ba_gt_v':int -> 'bb_gt_v':bool)))).
ut("path   const >", n_e_to_p_e1('>', loc('c.ml', 0, 0, 0, 0, 0, 0), 'gt_v':('a_gt_v':int -> 'b_gt_v':('ba_gt_v':int -> 'bb_gt_v':bool)), true,
                                 '>'@loc('c.ml', 0, 0, 0, 0, 0, 0):'gt_v':('a_gt_v':int -> 'b_gt_v':('ba_gt_v':int -> 'bb_gt_v':bool))-->'A_P_V'>'BA_P_V')).
ut("summ   const >", p_e_to_c1('>', loc('c.ml', 0, 0, 0, 0, 0, 0), 'gt_v':('a_gt_v':int -> 'b_gt_v':('ba_gt_v':int -> 'bb_gt_v':bool)), 'A_P_V'>'BA_P_V', {})).
